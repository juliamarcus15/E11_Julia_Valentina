...
Original file is located at
    https://colab.research.google.com/drive/1ItchzxPa1DCKB4CsMx7nvUOlmslwQER7
"""
...
filename = sys.argv[3] if len(sys.argv) > 3 else "mca_data.npz"
...
with CapeMCA() as mca:
    try:
        ...
        np.savez(filename, spectra=np.array(spectra), timestamps=np.array(read_times))
